"""
I am using DasiamRPN tracking algorithm to track the object in the video.
this algorithm is not created , i am using this algorithm from the open labeling package.
...
class dasiamrpn(object):
    """
    credits:
    Wrapper class for incorporating DaSiamRPN into my project
